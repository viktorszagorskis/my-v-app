package com.example.application.views.loggedusers;
...
@PageTitle("Logged Users")
@Route(value = "app-users", layout = MainLayout.class)
@RouteAlias(value = "", layout = MainLayout.class)
@PermitAll
public class LoggedUsersView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public LoggedUsersView() {
        addClassName("logged-users-view");
        setSizeFull();
        grid.setHeight("100%");
