package com.example.application.views.usersimagelist;
...
@PageTitle("Users Image List")
@Route(value = "image-list", layout = MainLayout.class)
@RolesAllowed("user")
@Tag("users-image-list-view")
@JsModule("./views/usersimagelist/users-image-list-view.ts")
public class UsersImageListView extends LitTemplate implements HasComponents, HasStyle {

    @Id
    private Select<String> sortBy;

    public UsersImageListView() {
        addClassNames("users-image-list-view", "flex", "flex-col", "h-full");
